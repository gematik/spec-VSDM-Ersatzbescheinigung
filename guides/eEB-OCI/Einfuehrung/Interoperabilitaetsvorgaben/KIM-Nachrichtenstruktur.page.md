...
3.	Neue EEB-Anfragen, die dieses geänderte Verfahren mit dem Coverage Profil `EEBCoverageNoAddressLine` berücksichtigen, haben die KIM-Dienstkennung **eEB;Anfrage;V1.1** zu verwenden. Erfolgreiche Prüfungen der Anfragen führen dann zu EEB-Bescheinungnen, die von den Kassen mit der KIM-Dienstkennung **eEB;Bescheinigung-KIM;V1.1** gesendet werden. <br /> Hierfür wird eine neue Version v1.1.0 der FHIR-Profile eingeführt, die ab sofort dort Verwendung finden, wo sie über die passende Dienstkennung bei einem Kostenträger angefordert werden. Mit der Profilaktualisierung werden auch die FHIR-Dependencies auf den aktuellen Stand angepasst, wie sie ab dem 01.10.2025 für das E-Rezept verbindlich werden.
...
|Dienstkennung & Kurzbeschreibung für Anfragen via KIM|**Dienstkennung: eEB;Anfrage;V1.1** <br /> Nachrichten-Typ: Anfragedaten zum Erhalt von Versichertendaten <br /> Verwendung: Vertragsärzte, Vertragszahnärzte, Krankenhäuser <br /> FHIR-Profil: EEBAnfrageBundle v1.1.0 <br />(EEBAnfrageBundle mit v1.0.0 werden mit EEBFehler v1.0.0 abgewiesen) <br /><br />  **Dienstkennung: eEB;Bescheinigung-KIM;V1.1** <br /> Nachrichten-Typ: Versichertendaten in verschiedenen Ausprägungen <br /> Verwendung: Krankenkassen, Versicherungsunternehmen <br /> FHIR-Profil: EEBBescheinigungBundle v1.1.0 <br /> <br /> **Dienstkennung: eEB;Fehler;V1.1**<br /> Nachrichten-Typ: Fehlermeldung bzgl. der Ermittlung der Daten des Versicherten <br />  Verwendung: Krankenkassen, Versicherungsunternehmen <br /> FHIR-Profil: EEBFehler v1.1.0 |
|Dienstkennung & Kurzbeschreibung für Anfragen via Kassen- und Versicherungs-Apps|**Dienstkennung: eEB;Bescheinigung-App;V1.1** <br /> Nachrichten-Typ: Versichertendaten in verschiedenen Ausprägungen <br /> Verwendung: Krankenkassen, Versicherungsunternehmen <br /> FHIR-Profil: EEBBescheinigungBundle v1.0.0 |
