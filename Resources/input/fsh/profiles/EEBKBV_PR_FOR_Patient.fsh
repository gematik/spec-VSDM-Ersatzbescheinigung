...
Invariant: -for-EEBAnfrageBundle
Description: "Identifier (GKV oder PKV) oder Name, Vorname, Geburtsdatum und Postleitzahl."
Severity: #error
Expression: "((identifier[versichertenId_GKV] or identifier[versichertenID_pkv]) or (name[name].family and name[name].given and birthDate and address[Strassenanschrift].postalCode))"
