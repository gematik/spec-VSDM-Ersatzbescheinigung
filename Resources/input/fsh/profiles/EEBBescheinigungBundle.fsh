...
Expression: "entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.30' implies entry.where(resource is Coverage).meta.profile.contains('https://gematik.de/fhir/eeb/StructureDefinition/EEBCoverageEgkNoAddressLine')"
