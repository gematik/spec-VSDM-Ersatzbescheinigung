...
Expression: "(entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.30' and entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.31' and entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.45' and entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.46' and entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.47' and entry.where(resource is MessageHeader).eventCoding.code != '1.2.276.0.76.4.49') implies entry.where(resource is Coverage).meta.profile.contains('https://gematik.de/fhir/eeb/StructureDefinition/EEBCoverageEgkNoAddressLine')"
