...
Severity: #error
Expression: "entry.where(resource is MessageHeader).resource.eventCoding.code = '1.2.276.0.76.4.49' implies (entry.where(resource is Coverage).resource.conformsTo('https://gematik.de/fhir/eeb/StructureDefinition/EEBCoverageEgk'))"
...
Severity: #error
Expression: "entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.30').not() and entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.31').not() and entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.45').not() and entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.46').not() and entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.47').not() and entry.where(resource is MessageHeader).resource.eventCoding.code.contains('1.2.276.0.76.4.49').not() implies ((entry.where(resource is Coverage).resource.conformsTo('https://gematik.de/fhir/eeb/StructureDefinition/EEBCoverageEgkNoAddressLine') or entry.where(resource is Coverage).resource.conformsTo('https://gematik.de/fhir/eeb/StructureDefinition/EEBCoverageNoEgk')) and entry.where(resource is Patient).resource.address.line.exists().not())"
